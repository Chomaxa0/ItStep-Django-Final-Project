...
SECRET_KEY = 'django-insecure-o)@gs76t(epo^(_dekn8&3#aqv)8ld(g&coa%j(xg7nesu1@9c'
...
# Ensure you have these settings for production
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Redirect to login page if not authenticated
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'candidate_list'  # Redirect to candidate list after login
